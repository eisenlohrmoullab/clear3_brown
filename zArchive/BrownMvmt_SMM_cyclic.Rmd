...
```{r user-params}
project_name <- "STEPSSMM"  # Change this to your project's short name
...
base_save_dir <- "output" # Change this to your desired output directory

# 3. Create some test text
test_message <- "Success: The output directory is configured correctly."

# 4. Save the text file into the folder
# file.path() automatically adds the correct slash (/) for your OS
file_path <- file.path(base_save_dir, "connection_test.txt")
writeLines(test_message, con = file_path)

# 5. Confirmation
if (file.exists(file_path)) {
  message("Test passed! File located at: ", file_path)
} else {
  message("Test failed.")
}
```
