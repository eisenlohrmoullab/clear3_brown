...
```{r}
steps_trait_sub %>% dplyr::select(id, class, IDASI_insom)

kruskal.test(IDASI_insom ~ class, data = steps_trait_sub)
...
#IDASI_traumint
kruskal.test(IDASI_traumint ~ class, data = steps_trait_sub)
...
```{r}
kruskal.test(IDASI_GENDEP ~ class, data = steps_trait_sub)
...
kruskal.test(IDASI_dys ~ class, data = steps_trait_sub)
...
```{r}
kruskal.test(IDASI_lass ~ class, data = steps_trait_sub)
...
```{r}
kruskal.test(IDASI_sui ~ class, data = steps_trait_sub)
...
kruskal.test(IDASI_apploss ~ class, data = steps_trait_sub)
...
```{r}
kruskal.test(IDASI_appgain ~ class, data = steps_trait_sub)
ggbetweenstats(
  data  = steps_trait_sub,
  x     = class,
  y     = IDASI_appgain,
...
```{r}
kruskal.test(IDASI_wb ~ class, data = steps_trait_sub)
ggbetweenstats(
  data  = steps_trait_sub,
  x     = class,
  y     = IDASI_wb,
...
```{r}
kruskal.test(IDASI_illtemp ~ class, data = steps_trait_sub)
ggbetweenstats(
  data  = steps_trait_sub,
  x     = class,
  y     = IDASI_illtemp,
...
```{r}
# test = kruskal.test(IDASI_mania ~ class, data = steps_trait_sub)
# test = capture.output(test)
...
```{r}
kruskal.test(IDASI_euph ~ class, data = steps_trait_sub)
...
```{r}
kruskal.test(IDASI_panic ~ class, data = steps_trait_sub)
...
# test = kruskal.test(IDASI_panic ~ class, data = steps_trait_sub)
# test = capture.output(test)
...
```{r}
kruskal.test(IDASI_socanx ~ class, data = steps_trait_sub)
...
# test = kruskal.test(caffeine ~ class, data = steps_trait_sub)
# test = capture.output(test)
...
```{r}
kruskal.test(age ~ class, data = steps_trait_sub)
ggbetweenstats(
  data  = steps_trait_sub,
  x     = class,
  y     = age,
...
```{r}
kruskal.test(passiveSI.m ~ class, data = steps_data_trait2_sub)
...
```{r}
kruskal.test(activeSI.m ~ class, data = steps_data_trait2_sub)
...
```{r}
kruskal.test(physicalpain.m ~ class, data = steps_data_trait2_sub)
...
```{r}
kruskal.test(numfullatt ~ class, data = steps_data_trait2_sub)
...
```{r}
kruskal.test(bmi ~ class, data = steps_data_trait2_sub)
...
# Ensure factors
steps_data_trait2_sub$class <- as.factor(steps_data_trait2_sub$class)
steps_data_trait2_sub$edu_clear123 <- as.factor(steps_data_trait2_sub$edu_clear123)
# Filter & drop unused levels
steps_edu <- steps_data_trait2_sub %>% 
  filter(!is.na(class), !is.na(edu_clear123)) %>%
  droplevels()
# Create table
tab <- table(steps_edu$class, steps_edu$edu_clear123)
print(tab)
# Run test
...
steps_sexo <- steps_data_trait2_sub %>% 
  filter(!is.na(class), !is.na(sexorientation)) %>%
  droplevels()
# Create table
tab <- table(steps_sexo$class, steps_sexo$sexorientation)
print(tab)
# Run test
...
steps_income <- steps_data_trait2_sub %>% 
  filter(!is.na(class), !is.na(houseincomecat)) %>%
  droplevels()
# Create table
tab <- table(steps_income$class, steps_income$houseincomecat)
print(tab)
# Run test
...
```{r}
REM_trait_sub %>% dplyr::select(id, class, IDASI_insom)

kruskal.test(IDASI_insom ~ class, data = REM_trait_sub)
...
#IDASI_traumint
kruskal.test(IDASI_traumint ~ class, data = REM_trait_sub)
...
```{r}
kruskal.test(IDASI_GENDEP ~ class, data = REM_trait_sub)
...
kruskal.test(IDASI_dys ~ class, data = REM_trait_sub)
...
```{r}
kruskal.test(IDASI_lass ~ class, data = REM_trait_sub)
...
```{r}
kruskal.test(IDASI_sui ~ class, data = REM_trait_sub)
...
kruskal.test(IDASI_apploss ~ class, data = REM_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_aploss.txt"))
ggbetweenstats(
  data  = REM_trait_sub,
...
```{r}
kruskal.test(IDASI_appgain ~ class, data = REM_trait_sub)
ggbetweenstats(
  data  = REM_trait_sub,
  x     = class,
  y     = IDASI_appgain,
...
```{r}
kruskal.test(IDASI_wb ~ class, data = REM_trait_sub)
ggbetweenstats(
  data  = REM_trait_sub,
  x     = class,
  y     = IDASI_wb,
...
```{r}
kruskal.test(IDASI_illtemp ~ class, data = REM_trait_sub)
ggbetweenstats(
  data  = REM_trait_sub,
  x     = class,
  y     = IDASI_illtemp,
...
```{r}
# test = kruskal.test(IDASI_mania ~ class, data = REM_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_mania.txt"))
ggbetweenstats(
  data  = REM_trait_sub,
...
```{r}
kruskal.test(IDASI_euph ~ class, data = REM_trait_sub)
...
```{r}
kruskal.test(IDASI_panic ~ class, data = REM_trait_sub)
...
# test = kruskal.test(IDASI_panic ~ class, data = REM_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_panic.txt"))
# ggsave(file.path(trait_path, "/panic_mania.png"))
```
...
```{r}
kruskal.test(IDASI_socanx ~ class, data = REM_trait_sub)
...
# test = kruskal.test(caffeine ~ class, data = REM_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/caffeine.txt"))
ggbetweenstats(
  data  = REM_trait_sub,
...
```{r}
# test = kruskal.test(age ~ class, data = REM_trait_sub)
# test = capture.output(test)
...
# Ensure factors
REM_trait_sub$class <- as.factor(REM_trait_sub$class)
...
REM_race_eth <- REM_trait_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(REM_race_eth$class, REM_race_eth$race_eth_analysis)
print(tab)
# Run test
...
REM_trait_sub %>% dplyr::select(id, class, race_eth_analysis)
```
...
```{r}
kruskal.test(passiveSI.m ~ class, data = REM_data_trait2_sub)
...
```{r}
kruskal.test(activeSI.m ~ class, data = REM_data_trait2_sub)
...
kruskal.test(DRSP1_depblue.m ~ class, data = REM_data_trait2_sub)
...
```{r}
test = kruskal.test(DRSPx_cramps.m ~ class, data = REM_data_trait2_sub)
test = capture.output(test)
...
# test = kruskal.test(DRSP4_anxious.m ~ class, data = REM_data_trait2_sub)
# test = capture.output(test)
#writeLines(test, file.path(trait_path, "DRSP4_anxious.m.txt"))
ggbetweenstats(
  data  = REM_data_trait2_sub,
...
```{r}
kruskal.test(DRSP7b_irritable.m ~ class, data = REM_data_trait2_sub)
...
```
```{r}
kruskal.test(DRSP7_angirr.m ~ class, data = REM_data_trait2_sub)
...
kruskal.test(PANAS_happy.m ~ class, data = REM_data_trait2_sub)
ggbetweenstats(
  data  = REM_data_trait2_sub,
  x     = class,
  y     = PANAS_happy.m,
...
kruskal.test(DRSPx_notenjoy.m ~ class, data = REM_data_trait2_sub)
...
```{r}
kruskal.test(physicalpain.m ~ class, data = REM_data_trait2_sub)
...
```{r}
# test = kruskal.test(numdrinks_yest.m ~ class, data = REM_data_trait2_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "numdrinks.m.txt"))
ggbetweenstats(
  data  = REM_data_trait2_sub,
...
```{r}
kruskal.test(numfullatt ~ class, data = REM_data_trait2_sub)
...
```{r}
kruskal.test(bmi ~ class, data = REM_data_trait2_sub)
...
# Ensure factors
REM_data_trait2_sub$class <- as.factor(REM_data_trait2_sub$class)
...
REM_edu <- REM_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(REM_edu$class, REM_edu$edu_clear123)
print(tab)
# Run test
...
REM_sexo <- REM_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(REM_sexo$class, REM_sexo$sexorientation)
print(tab)
# Run test
...
REM_income <- REM_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(REM_income$class, REM_income$houseincomecat)
print(tab)
# Run test
...
```{r}
REM_data_trait2_sub %>% filter(class == 1) %>% summarise(mean = mean(DRSPx_cramps.m), sd = sd(DRSPx_cramps.m))

REM_data_trait2_sub %>% filter(class == 2) %>% summarise(mean = mean(DRSPx_cramps.m), sd = sd(DRSPx_cramps.m))
```
...
```{r}
SE_trait_sub %>% dplyr::select(id, class, IDASI_insom)

kruskal.test(IDASI_insom ~ class, data = SE_trait_sub)
...
#IDASI_traumint
kruskal.test(IDASI_traumint ~ class, data = SE_trait_sub)
...
```{r}
kruskal.test(IDASI_GENDEP ~ class, data = SE_trait_sub)
...
kruskal.test(IDASI_dys ~ class, data = SE_trait_sub)
...
```{r}
kruskal.test(IDASI_lass ~ class, data = SE_trait_sub)
...
```{r}
kruskal.test(IDASI_sui ~ class, data = SE_trait_sub)
...
kruskal.test(IDASI_apploss ~ class, data = SE_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_aploss.txt"))
ggbetweenstats(
  data  = SE_trait_sub,
...
```{r}
kruskal.test(IDASI_appgain ~ class, data = SE_trait_sub)
ggbetweenstats(
  data  = SE_trait_sub,
  x     = class,
  y     = IDASI_appgain,
...
```{r}
kruskal.test(IDASI_wb ~ class, data = SE_trait_sub)
ggbetweenstats(
  data  = SE_trait_sub,
  x     = class,
  y     = IDASI_wb,
...
```{r}
kruskal.test(IDASI_illtemp ~ class, data = SE_trait_sub)
ggbetweenstats(
  data  = SE_trait_sub,
  x     = class,
  y     = IDASI_illtemp,
...
```{r}
# test = kruskal.test(IDASI_mania ~ class, data = SE_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_mania.txt"))
ggbetweenstats(
  data  = SE_trait_sub,
...
```{r}
kruskal.test(IDASI_euph ~ class, data = SE_trait_sub)
...
```{r}
kruskal.test(IDASI_panic ~ class, data = SE_trait_sub)
...
# test = kruskal.test(IDASI_panic ~ class, data = SE_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_panic.txt"))
# ggsave(file.path(trait_path, "/panic_mania.png"))
```
...
```{r}
kruskal.test(IDASI_socanx ~ class, data = SE_trait_sub)
...
test = kruskal.test(caffeine ~ class, data = SE_trait_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "/caffeine.txt"))
ggbetweenstats(
  data  = SE_trait_sub,
...
```{r}
test = kruskal.test(age ~ class, data = SE_trait_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "/age.txt"))
ggbetweenstats(
  data  = SE_trait_sub,
...
# Ensure factors
SE_trait_sub$class <- as.factor(SE_trait_sub$class)
...
SE_race_eth <- SE_trait_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SE_race_eth$class, SE_race_eth$race_eth_analysis)
print(tab)
# Run test
...
SE_trait_sub %>% dplyr::select(id, class, race_eth_analysis)
```
...
```{r}
kruskal.test(passiveSI.m ~ class, data = SE_data_trait2_sub)
...
```{r}
kruskal.test(activeSI.m ~ class, data = SE_data_trait2_sub)
...
kruskal.test(DRSP1_depblue.m ~ class, data = SE_data_trait2_sub)
...
```{r}
kruskal.test(DRSPx_cramps.m ~ class, data = SE_data_trait2_sub)
...
# test = kruskal.test(DRSP4_anxious.m ~ class, data = SE_data_trait2_sub)
# test = capture.output(test)
writeLines(test, file.path(trait_path, "DRSP4_anxious.m.txt"))
ggbetweenstats(
  data  = SE_data_trait2_sub,
...
```{r}
kruskal.test(DRSP7b_irritable.m ~ class, data = SE_data_trait2_sub)
...
```
```{r}
kruskal.test(DRSP7_angirr.m ~ class, data = SE_data_trait2_sub)
...
kruskal.test(PANAS_happy.m ~ class, data = SE_data_trait2_sub)
ggbetweenstats(
  data  = SE_data_trait2_sub,
  x     = class,
  y     = PANAS_happy.m,
...
kruskal.test(DRSPx_notenjoy.m ~ class, data = SE_data_trait2_sub)
...
```{r}
kruskal.test(physicalpain.m ~ class, data = SE_data_trait2_sub)
...
```{r}
# test = kruskal.test(numdrinks_yest.m ~ class, data = SE_data_trait2_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "numdrinks.m.txt"))
ggbetweenstats(
  data  = SE_data_trait2_sub,
...
```{r}
kruskal.test(numfullatt ~ class, data = SE_data_trait2_sub)
...
```{r}
kruskal.test(bmi ~ class, data = SE_data_trait2_sub)
...
# Ensure factors
SE_data_trait2_sub$class <- as.factor(SE_data_trait2_sub$class)
...
SE_edu <- SE_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SE_edu$class, SE_edu$edu_clear123)
print(tab)
# Run test
...
SE_sexo <- SE_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SE_sexo$class, SE_sexo$sexorientation)
print(tab)
# Run test
...
SE_income <- SE_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SE_income$class, SE_income$houseincomecat)
print(tab)
# Run test
...
```{r}
SQ_trait_sub %>% dplyr::select(id, class, IDASI_insom)

kruskal.test(IDASI_insom ~ class, data = SQ_trait_sub)
...
```{r}
kruskal.test(IDASI_traumint ~ class, data = SQ_trait_sub)
...
```{r}
kruskal.test(IDASI_GENDEP ~ class, data = SQ_trait_sub)
...
kruskal.test(IDASI_dys ~ class, data = SQ_trait_sub)
...
```{r}
test = kruskal.test(IDASI_lass ~ class, data = SQ_trait_sub)
test = capture.output(test)
...
```{r}
kruskal.test(IDASI_sui ~ class, data = SQ_trait_sub)
...
kruskal.test(IDASI_apploss ~ class, data = SQ_trait_sub)
...
```{r}
# test = kruskal.test(IDASI_appgain ~ class, data = SQ_trait_sub)
# test = capture.output(test)
...
```{r}
kruskal.test(IDASI_wb ~ class, data = SQ_trait_sub)
ggbetweenstats(
  data  = SQ_trait_sub,
  x     = class,
  y     = IDASI_wb,
...
```{r}
kruskal.test(IDASI_illtemp ~ class, data = SQ_trait_sub)
ggbetweenstats(
  data  = SQ_trait_sub,
  x     = class,
  y     = IDASI_illtemp,
...
```{r}
kruskal.test(IDASI_mania ~ class, data = SQ_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_mania.txt"))
ggbetweenstats(
  data  = SQ_trait_sub,
...
```{r}
kruskal.test(IDASI_euph ~ class, data = SQ_trait_sub)
...
```{r}
kruskal.test(IDASI_panic ~ class, data = SQ_trait_sub)
...
# test = kruskal.test(IDASI_panic ~ class, data = D15_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_panic.txt"))
# ggsave(file.path(trait_path, "/panic_mania.png"))
```
...
```{r}
kruskal.test(IDASI_socanx ~ class, data = SQ_trait_sub)
...
# test = kruskal.test(caffeine ~ class, data = D15_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/caffeine.txt"))
ggbetweenstats(
  data  = SQ_trait_sub,
...
```{r}
kruskal.test(age ~ class, data = SQ_trait_sub)
ggbetweenstats(
  data  = SQ_trait_sub,
  x     = class,
  y     = age,
...
# Ensure factors
SQ_trait_sub$class <- as.factor(SQ_trait_sub$class)
...
SQ_race_eth <- SQ_trait_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SQ_race_eth$class, SQ_race_eth$race_eth_analysis)
print(tab)
# Run test
...
```{r}
kruskal.test(passiveSI.m ~ class, data = SQ_data_trait2_sub)
...
```{r}
kruskal.test(activeSI.m ~ class, data = SQ_data_trait2_sub)
...
kruskal.test(drsp1_depblue.m ~ class, data = SQ_data_trait2_sub)
...
```{r}
kruskal.test(drspx_cramps.m ~ class, data = SQ_data_trait2_sub)
...
# test = kruskal.test(drsp4_anxious.m ~ class, data = SQ_data_trait2_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "drsp4_anxious.m.txt"))
ggbetweenstats(
  data  = SQ_data_trait2_sub,
...
```{r}
kruskal.test(drsp7b_irritable.m ~ class, data = SQ_data_trait2_sub)
...
```{r}
test = kruskal.test(drsp7_angirr.m ~ class, data = SQ_data_trait2_sub)
...
test = kruskal.test(panas_happy.m ~ class, data = SQ_data_trait2_sub)
test = capture.output(test)
...
test = kruskal.test(drspx_notenjoy.m ~ class, data = SQ_data_trait2_sub)
test = capture.output(test)
...
```{r}
kruskal.test(physicalpain.m ~ class, data = SQ_data_trait2_sub)
...
```{r}
kruskal.test(numdrinks_yest.m ~ class, data = SQ_data_trait2_sub)
# test = capture.output(test)
...
```{r}
kruskal.test(numfullatt ~ class, data = SQ_data_trait2_sub)
...
```{r}
kruskal.test(bmi ~ class, data = SQ_data_trait2_sub)
...
# Ensure factors
SQ_data_trait2_sub$class <- as.factor(SQ_data_trait2_sub$class)
...
SQ_edu <- SQ_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SQ_edu$class, SQ_edu$edu_clear123)
print(tab)
# Run test
...
SQ_sexo <- SQ_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SQ_sexo$class, SQ_sexo$sexorientation)
print(tab)
# Run test
...
SQ_income <- SQ_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(SQ_income$class, SQ_income$houseincomecat)
print(tab)
# Run test
...
```{r}
D11_trait_sub %>% dplyr::select(id, class, IDASI_insom)

kruskal.test(IDASI_insom ~ class, data = D11_trait_sub)
...
```{r}
kruskal.test(IDASI_traumint ~ class, data = D11_trait_sub)
...
```{r}
kruskal.test(IDASI_GENDEP ~ class, data = D11_trait_sub)
...
kruskal.test(IDASI_dys ~ class, data = D11_trait_sub)
...
```{r}
# test = kruskal.test(IDASI_lass ~ class, data = D11_trait_sub)
# test = capture.output(test)
# write_lines(test, paste0(trait_path, "/lassitude.txt"))
ggbetweenstats(
  data  = D11_trait_sub,
...
```{r}
kruskal.test(IDASI_sui ~ class, data = D11_trait_sub)
...
```{r}
# trait_path = "/Users/anishan/Library/CloudStorage/Box-Box/00 - CLEAR Lab (Locked Folders)/02 - Data Management, Analysis, and Papers/Studies_Projects/CLEAR3/03_analytic_projects/CLEAR3_OURA_Sleep_Baseline/02_code_dataedits_output/sleep_SMM/cyclic/20250825/drsp15_troublesleep/trait_comparisons"
kruskal.test(IDASI_apploss ~ class, data = D11_trait_sub)
...
```{r}
# test = kruskal.test(IDASI_appgain ~ class, data = D11_trait_sub)
# test = capture.output(test)
# write_lines(test, paste0(trait_path, "/appgain.txt"))
ggbetweenstats(
  data  = D11_trait_sub,
...
```{r}
kruskal.test(IDASI_wb ~ class, data = D11_trait_sub)
ggbetweenstats(
  data  = D11_trait_sub,
  x     = class,
  y     = IDASI_wb,
...
```{r}
kruskal.test(IDASI_illtemp ~ class, data = D11_trait_sub)
ggbetweenstats(
  data  = D11_trait_sub,
  x     = class,
  y     = IDASI_illtemp,
...
```{r}
kruskal.test(IDASI_mania ~ class, data = D11_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_mania.txt"))
ggbetweenstats(
  data  = D11_trait_sub,
...
```{r}
kruskal.test(IDASI_euph ~ class, data = D11_trait_sub)
...
```{r}
kruskal.test(IDASI_panic ~ class, data = D11_trait_sub)
...
```{r}
kruskal.test(IDASI_socanx ~ class, data = D11_trait_sub)
...
```{r}
kruskal.test(age ~ class, data = D11_trait_sub)
ggbetweenstats(
  data  = D11_trait_sub,
  x     = class,
  y     = age,
...
# Ensure factors
D11_trait_sub$class <- as.factor(D11_trait_sub$class)
...
D11_race_eth <- D11_trait_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D11_race_eth$class, D11_race_eth$race_eth_analysis)
print(tab)
# Run test
...
```{r}
test = kruskal.test(passiveSI.m ~ class, data = drsp11_data_trait2_sub)
test = capture.output(test)
...
```{r}
kruskal.test(activeSI.m ~ class, data = drsp11_data_trait2_sub)
...
kruskal.test(drsp1_depblue.m ~ class, data = drsp11_data_trait2_sub)
test = capture.output(test)
...
```{r}
kruskal.test(drspx_cramps.m ~ class, data = drsp11_data_trait2_sub)
...
# test = kruskal.test(drsp4_anxious.m ~ class, data = drsp11_data_trait2_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "drsp4_anxious.m.txt"))
ggbetweenstats(
  data  = drsp11_data_trait2_sub,
...
```{r}
kruskal.test(drsp7b_irritable.m ~ class, data = drsp11_data_trait2_sub)
...
```
```{r}
test = kruskal.test(drsp7_angirr.m ~ class, data = drsp11_data_trait2_sub)
...
kruskal.test(panas_happy.m ~ class, data = drsp11_data_trait2_sub)
ggbetweenstats(
  data  = drsp11_data_trait2_sub,
  x     = class,
  y     = panas_happy.m,
...
kruskal.test(drspx_notenjoy.m ~ class, data = drsp11_data_trait2_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "notenjoy.m.txt"))
ggbetweenstats(
  data  = drsp11_data_trait2_sub,
...
```{r}
test = kruskal.test(physicalpain.m ~ class, data = drsp11_data_trait2_sub)
test = capture.output(test)
...
```{r}
# kruskal.test(numdrinks_yest.m ~ class, data = drsp11_data_trait2_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "numdrinks_yest.m.txt"))
ggbetweenstats(
  data  = drsp11_data_trait2_sub,
...
```{r}
kruskal.test(numfullatt ~ class, data = drsp11_data_trait2_sub)
...
```{r}
kruskal.test(bmi ~ class, data = drsp11_data_trait2_sub)
...
# Ensure factors
drsp11_data_trait2_sub$class <- as.factor(drsp11_data_trait2_sub$class)
...
D11_edu <- drsp11_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D11_edu$class, D11_edu$edu_clear123)
print(tab)
# Run test
...
D11_sexo <- drsp11_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D11_sexo$class, D11_sexo$sexorientation)
print(tab)
# Run test
...
D11_income <- drsp11_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D11_income$class, D11_income$houseincomecat)
print(tab)
# Run test
...
```{r}
D14_trait_sub %>% dplyr::select(id, class, IDASI_insom)

kruskal.test(IDASI_insom ~ class, data = D14_trait_sub)
...
```{r}
kruskal.test(IDASI_traumint ~ class, data = D14_trait_sub)
...
```{r}
kruskal.test(IDASI_GENDEP ~ class, data = D14_trait_sub)
test = capture.output(test)
...
kruskal.test(IDASI_dys ~ class, data = D14_trait_sub)
...
```{r}
kruskal.test(IDASI_sui ~ class, data = D14_trait_sub)
...
```{r}
# trait_path = "/Users/anishan/Library/CloudStorage/Box-Box/00 - CLEAR Lab (Locked Folders)/02 - Data Management, Analysis, and Papers/Studies_Projects/CLEAR3/03_analytic_projects/CLEAR3_OURA_Sleep_Baseline/02_code_dataedits_output/sleep_SMM/cyclic/20250825/drsp15_troublesleep/trait_comparisons"
kruskal.test(IDASI_apploss ~ class, data = D14_trait_sub)
...
```{r}
test = kruskal.test(IDASI_appgain ~ class, data = D14_trait_sub)
test = capture.output(test)
write_lines(test, paste0(trait_path, "/appgain.txt"))
ggbetweenstats(
  data  = D14_trait_sub,
...
```{r}
kruskal.test(IDASI_wb ~ class, data = D14_trait_sub)
ggbetweenstats(
  data  = D14_trait_sub,
  x     = class,
  y     = IDASI_wb,
...
```{r}
test = kruskal.test(IDASI_illtemp ~ class, data = D14_trait_sub)
test = capture.output(test)
...
```{r}
kruskal.test(IDASI_mania ~ class, data = D14_trait_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "/IDASI_mania.txt"))
ggbetweenstats(
  data  = D14_trait_sub,
...
```{r}
kruskal.test(IDASI_euph ~ class, data = D14_trait_sub)
...
```{r}
kruskal.test(IDASI_panic ~ class, data = D14_trait_sub)
...
```{r}
kruskal.test(IDASI_socanx ~ class, data = D14_trait_sub)
...
test = kruskal.test(caffeine ~ class, data = D14_trait_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "/caffeine.txt"))
ggbetweenstats(
  data  = D14_trait_sub,
...
```{r}
kruskal.test(age ~ class, data = D14_trait_sub)
ggbetweenstats(
  data  = D14_trait_sub,
  x     = class,
  y     = age,
...
# Ensure factors
D14_trait_sub$class <- as.factor(D14_trait_sub$class)
...
D14_race_eth <- D14_trait_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D14_race_eth$class, D14_race_eth$race_eth_analysis)
print(tab)
# Run test
...
```{r}
kruskal.test(passiveSI.m ~ class, data = drsp14_data_trait2_sub)
...
```{r}
kruskal.test(activeSI.m ~ class, data = drsp14_data_trait2_sub)
...
kruskal.test(drsp1_depblue.m ~ class, data = drsp14_data_trait2_sub)
...
```{r}
kruskal.test(drspx_cramps.m ~ class, data = drsp14_data_trait2_sub)
...
# test = kruskal.test(drsp4_anxious.m ~ class, data = drsp14_data_trait2_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "drsp4_anxious.m.txt"))
ggbetweenstats(
  data  = drsp14_data_trait2_sub,
...
```{r}
kruskal.test(drsp7b_irritable.m ~ class, data = drsp14_data_trait2_sub)
...
```{r}
test = kruskal.test(drsp7_angirr.m ~ class, data = drsp14_data_trait2_sub)
...
kruskal.test(panas_happy.m ~ class, data = drsp14_data_trait2_sub)
ggbetweenstats(
  data  = drsp14_data_trait2_sub,
  x     = class,
  y     = panas_happy.m,
...
kruskal.test(drspx_notenjoy.m ~ class, data = drsp14_data_trait2_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "notenjoy.m.txt"))
ggbetweenstats(
  data  = drsp14_data_trait2_sub,
...
```{r}
kruskal.test(physicalpain.m ~ class, data = drsp14_data_trait2_sub)
...
```{r}
# kruskal.test(numdrinks_yest.m ~ class, data = drsp14_data_trait2_sub)
# test = capture.output(test)
# writeLines(test, file.path(trait_path, "numdrinks_yest.m.txt"))
ggbetweenstats(
  data  = drsp14_data_trait2_sub,
...
```{r}
kruskal.test(numfullatt ~ class, data = drsp14_data_trait2_sub)
...
```{r}
kruskal.test(bmi ~ class, data = drsp14_data_trait2_sub)
...
# Ensure factors
drsp14_data_trait2_sub$class <- as.factor(drsp14_data_trait2_sub$class)
...
D14_edu <- drsp14_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D14_edu$class, D14_edu$edu_clear123)
print(tab)
# Run test
...
D14_sexo <- drsp14_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D14_sexo$class, D14_sexo$sexorientation)
print(tab)
# Run test
...
D14_income <- drsp14_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D14_income$class, D14_income$houseincomecat)
print(tab)
# Run test
...
```{r}
D15_trait_sub %>% dplyr::select(id, class, IDASI_insom)

kruskal.test(IDASI_insom ~ class, data = D15_trait_sub)
...
#IDASI_traumint
kruskal.test(IDASI_traumint ~ class, data = D15_trait_sub)
...
```{r}
kruskal.test(IDASI_GENDEP ~ class, data = D15_trait_sub)
...
kruskal.test(IDASI_dys ~ class, data = D15_trait_sub)
...
```{r}
kruskal.test(IDASI_lass ~ class, data = D15_trait_sub)
...
```{r}
kruskal.test(IDASI_sui ~ class, data = D15_trait_sub)
...
```{r}
trait_path = "/Users/anishan/Library/CloudStorage/Box-Box/00 - CLEAR Lab (Locked Folders)/02 - Data Management, Analysis, and Papers/Studies_Projects/CLEAR3/03_analytic_projects/CLEAR3_OURA_Sleep_Baseline/02_code_dataedits_output/sleep_SMM/cyclic/20250825/drsp15_troublesleep/trait_comparisons"
test = kruskal.test(IDASI_apploss ~ class, data = D15_trait_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "/IDASI_aploss.txt"))
ggbetweenstats(
  data  = D15_trait_sub,
...
```{r}
kruskal.test(IDASI_appgain ~ class, data = D15_trait_sub)
ggbetweenstats(
  data  = D15_trait_sub,
  x     = class,
  y     = IDASI_appgain,
...
```{r}
kruskal.test(IDASI_wb ~ class, data = D15_trait_sub)
ggbetweenstats(
  data  = D15_trait_sub,
  x     = class,
  y     = IDASI_wb,
...
```{r}
kruskal.test(IDASI_illtemp ~ class, data = D15_trait_sub)
ggbetweenstats(
  data  = D15_trait_sub,
  x     = class,
  y     = IDASI_illtemp,
...
```{r}
test = kruskal.test(IDASI_mania ~ class, data = D15_trait_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "/IDASI_mania.txt"))
ggbetweenstats(
  data  = D15_trait_sub,
...
```{r}
kruskal.test(IDASI_euph ~ class, data = D15_trait_sub)
...
```{r}
kruskal.test(IDASI_panic ~ class, data = D15_trait_sub)
...
```{r}
kruskal.test(IDASI_socanx ~ class, data = D15_trait_sub)
...
```{r}
kruskal.test(age ~ class, data = D15_trait_sub)
ggbetweenstats(
  data  = D15_trait_sub,
  x     = class,
  y     = age,
...
# Ensure factors
D15_trait_sub$class <- as.factor(D15_trait_sub$class)
...
D15_race_eth <- D15_trait_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D15_race_eth$class, D15_race_eth$race_eth_analysis)
print(tab)
# Run test
...
D15_trait_sub %>% dplyr::select(id, class, race_eth_analysis)
```
...
```{r}
kruskal.test(passiveSI.m ~ class, data = drsp15_data_trait2_sub)
...
```{r}
kruskal.test(activeSI.m ~ class, data = drsp15_data_trait2_sub)
...
kruskal.test(drsp1_depblue.m ~ class, data = drsp15_data_trait2_sub)
...
```{r}
kruskal.test(drspx_cramps.m ~ class, data = drsp15_data_trait2_sub)
...
test = kruskal.test(drsp4_anxious.m ~ class, data = drsp15_data_trait2_sub)
test = capture.output(test)
writeLines(test, file.path(trait_path, "drsp4_anxious.m.txt"))
ggbetweenstats(
  data  = drsp15_data_trait2_sub,
...
```{r}
kruskal.test(drsp7b_irritable.m ~ class, data = drsp15_data_trait2_sub)
...
```
```{r}
kruskal.test(drsp7_angirr.m ~ class, data = drsp15_data_trait2_sub)
...
kruskal.test(panas_happy.m ~ class, data = drsp15_data_trait2_sub)
ggbetweenstats(
  data  = drsp15_data_trait2_sub,
  x     = class,
  y     = panas_happy.m,
...
kruskal.test(drspx_notenjoy.m ~ class, data = drsp15_data_trait2_sub)
...
```{r}
kruskal.test(physicalpain.m ~ class, data = drsp15_data_trait2_sub)
...
```{r}
kruskal.test(numdrinks_yest.m ~ class, data = drsp15_data_trait2_sub)
...
```{r}
kruskal.test(numfullatt ~ class, data = drsp15_data_trait2_sub)
...
```{r}
kruskal.test(bmi ~ class, data = drsp15_data_trait2_sub)
...
# Ensure factors
drsp15_data_trait2_sub$class <- as.factor(drsp15_data_trait2_sub$class)
...
D15_edu <- drsp15_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D15_edu$class, D15_edu$edu_clear123)
print(tab)
# Run test
...
D15_sexo <- drsp15_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D15_sexo$class, D15_sexo$sexorientation)
print(tab)
# Run test
...
D15_income <- drsp15_data_trait2_sub %>% 
  ...
  droplevels()
# Create table
tab <- table(D15_income$class, D15_income$houseincomecat)
print(tab)
# Run test
