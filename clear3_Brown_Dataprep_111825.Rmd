...
generate_correlation_heatmap <- function(
    ...
    label_size = 4.6,
    diag_label_size = 6,
    subtitle_text = "Upper: Within-person (Spearman); Lower: Between-person (rmcorr); Diagonal: ICC"
) {
...
if (exists("df") && exists("corrplotlist")) {
  ...
  ggsave("output/correlation_heatmap_steps.png", plot = correlation_heatmap, width = 9, height = 6)
